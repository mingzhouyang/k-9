...
/**
 * This is a meta-Account that represents one or more accounts with filters on
 * them. The filter specification is defined by
 * {@link org.ancode.secmail.activity.SearchModifier}.
 */
public class SearchAccount implements BaseAccount, SearchSpecification, Serializable {
	 ...
	 *            strings and will be passed on to the {@code SearchAccount}
	 *            instance.
	 * 
	...
	/**
	 * Create a {@code SearchAccount} instance for the special account
	 * "All messages".
	 * 
	 * @param context
	 *            A {@link Context} instance that will be used to get localized
