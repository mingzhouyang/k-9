...
public class AccountSetupBasics extends K9Activity implements OnClickListener, TextWatcher {
	...
	private void validateFields() {
		...
		boolean valid = Utility.requiredFieldValid(mEmailView) && Utility.requiredFieldValid(mPasswordView)
	...
	private void finishAutoSetup() {
		...
		try {
			...
			if (outgoingUsername != null) {
				...
				outgoingUri = new URI(outgoingUriTemplate.getScheme(), null, outgoingUriTemplate.getHost(),
	...
	private void onManualSetup() {
		...
		try {
			...
			URI uri = new URI("placeholder", userEnc + ":" + passwordEnc, "mail." + domain, -1, null, null, null);
