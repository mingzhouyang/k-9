...
public class AccountSettings extends K9PreferenceActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String currentRingtone = (!mAccount.getNotificationSetting().shouldRing() ? null : mAccount
				.getNotificationSetting().getRingtone());
		...
		if (!new Apg().isAvailable(this)) {
			...
			if (apgIndex >= 0) {
				cryptoAppEntries[apgIndex] = "APG ("
						+ getResources().getString(R.string.account_settings_crypto_app_not_available) + ")";
	...
	private void doVibrateTest(Preference preference) {
		...
		vibrate.vibrate(
				NotificationSetting.getVibration(Integer.parseInt(mAccountVibratePattern.getValue()),
