...
public class Prefs extends K9PreferenceActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		initListPreference(mLanguage, K9.getK9Language(), entryVector.toArray(EMPTY_CHAR_SEQUENCE_ARRAY),
		...
		mConfirmActions.setCheckedItems(new boolean[] { K9.confirmDelete(), K9.confirmDeleteStarred(),
				K9.confirmSpam(), K9.confirmMarkAllAsRead() });

		mNotificationHideSubject = setupListPreference(PREFERENCE_NOTIFICATION_HIDE_SUBJECT, K9
		...
		// If we don't have any accounts with an archive folder, then don't
