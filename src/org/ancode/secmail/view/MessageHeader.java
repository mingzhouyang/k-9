...
public class MessageHeader extends ScrollView implements OnClickListener {
	...
	public MessageHeader(Context context, AttributeSet attrs) {
		...
		mTimeFormat = android.text.format.DateFormat.getTimeFormat(mContext); // 12/24
																				// date
																				// format
	...
	public boolean additionalHeadersVisible() {
		return (mAdditionalHeadersView != null && mAdditionalHeadersView.getVisibility() == View.VISIBLE);
	}
	...
	private List<HeaderEntry> getAdditionalHeaders(final Message message) throws MessagingException {
		 ...
		 * message view header. But do show "From", "To", and "Cc" again. This
		 * time including the email addresses. See issue 1805.
		 */
